...
echo "=== Starting Local Stage with UI ==="
...
echo "✓ Inference Server 1: http://localhost:8001"
echo "✓ Inference Server 2: http://localhost:8002"
echo "✓ Web UI: http://localhost:8080"
echo ""
echo "Open http://localhost:8080 in your browser to use the control panel"
echo ""
echo "Press Ctrl+C to stop all services"

# Wait for user interrupt
trap "echo ''; echo 'Shutting down...'; kill $INFERENCE_PID1 $INFERENCE_PID2 $UI_PID 2>/dev/null || true; wait $INFERENCE_PID1 $INFERENCE_PID2 $UI_PID 2>/dev/null || true; echo 'Done'; exit" INT TERM
